...
//               bos.toString().trim().replace("' ", "'").replace(" '","'"));
    ...
    //region 3 intoarce identificator intrebare dupa nume
    @Test
    ...
    //region 4 intoarce toate intrebarile din system
    @Test
    ...
    //region 6 intoarce identificator chestionar dupa nume
    ...
    //region 7 intoarce toate chestionarele din system
    @Test
    ...
    //region 8 intoarce detaliile unui chestionar in functie de identificatory java
    ...
    //region 9 incarca raspunsuri chestionar
    @Test
    ...
    public void testSubmitQuiz2Of3QuestionsAnswered()
    {
        ...
        // action
        Tema1.main(new String[]{"-create-question", "-u 'test'", "-p 'test'", "-text 'Temperatura se poate masura in'", "-type 'multiple'","-answer-1 'Celsius'", "-answer-1-is-correct '1'", "-answer-2 'Litri'", "-answer-2-is-correct '0'", "-answer-3 'Fahrenheit'", "-answer-3-is-correct '1'"});
    ...
    //region 11 intoarce solutiile mele
    @Test
